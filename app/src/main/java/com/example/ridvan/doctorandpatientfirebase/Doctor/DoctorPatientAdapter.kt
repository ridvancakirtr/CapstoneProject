...
import com.example.ridvan.doctorandpatientfirebase.EditPatientActivity
import com.example.ridvan.doctorandpatientfirebase.Patient.PatientDataActivity
...
import java.util.ArrayList
     ...
     */
class DoctorPatientAdapter(allPatients: ArrayList<PatientDataModel>) : RecyclerView.Adapter<DoctorPatientAdapter.PatientViewHolder>() {
    ...
    override fun onBindViewHolder(holder: PatientViewHolder, position: Int) {
        ...
        holder.oneLinePatient.setOnClickListener {
            Toast.makeText(holder.itemView.context,"Selected Patient : "+patientAll.get(position).patient_name_surname, Toast.LENGTH_SHORT).show()
            var intent= Intent(holder.itemView.context, PatientDataActivity::class.java)
