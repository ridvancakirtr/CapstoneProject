...
class DoctorDataModel {
    ...
    var doctor_profile_pictures:String?=null
    ...
    constructor(doctor_name_surname: String?, doctor_profile_pictures: String?, doctor_gender: String?, doctor_area_expertise: String?, doctor_hospital_name: String?, doctor_office_phone: String?, doctor_mobile_phone: String?, doctor_email: String?, doctor_password: String?, level: String?, doctor_user_id: String?) {
